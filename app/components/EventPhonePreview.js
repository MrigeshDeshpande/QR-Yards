                    ...
                    <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative">
                        ...
                        <div className="h-[calc(100%-24px)] overflow-y-auto">
                            ...
                            <div className="bg-gradient-to-br from-indigo-600 to-purple-600 p-6 text-white">
                                ...
                                <h2 className="text-2xl font-bold mb-2">Annual Tech Conference 2024</h2>
                            ...
                            <div className="p-4">
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-semibold text-gray-900">6:00 PM - 10:00 PM</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-semibold text-gray-900">Convention Center, Main Hall</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-semibold text-gray-900">500+ registered</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Join industry leaders and innovators for a day of inspiring talks, networking, and hands-on workshops.
                                    </p>
                                </div>
