...
export default function PlaylistBuilder() {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto pb-32">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-6">Complete the content of the QR</h1>
                <Input
                ...
                >
                    <div className="space-y-4 mt-4">
                        <Input
                            ...
                            onChange={(e) => updateQrData(null, 'playlistName', e.target.value)}
                        />
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) => updateQrData(null, 'playlistDescription', e.target.value)}
                            ></textarea>
                        </div>
                    </div>
                </Accordion>
