    ...
    >
      <div className="mt-4">
        ...
        <p className="text-xs text-gray-500 mb-4">
          Set the dates on which your content will be shown through the QR. At
          the end of that period, it will be disabled.
        </p>
        <Switch
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateQrData("schedule", "startDate", e.target.value)
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateQrData("schedule", "endDate", e.target.value)
              }
            />
          </div>
        </div>
