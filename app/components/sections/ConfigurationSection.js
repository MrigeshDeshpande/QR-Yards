  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        ...
        <div className="relative">
          <select
            ...
            onChange={(e) =>
              updateQrData("configuration", "folder", e.target.value)
            }
          >
      ...
      <div className="mt-6">
        ...
        <p className="text-xs text-gray-500 mb-3">
          Now you can use your own domain in your QR codes. Add and configure a
          custom domain...
        </p>
        ...
        <Switch
          ...
          onChange={(val) => {
            const newPasswordState = {
              ...qrState.content.configuration.password,
              enable: val,
            };
