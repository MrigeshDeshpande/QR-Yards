...
import { ExternalLink, Globe, FileText, ShoppingBag, Calendar } from "lucide-react";

export default function LinksPhonePreview() {
    const links = [
        { icon: Globe, title: "Website", url: "example.com", color: "bg-blue-100 text-blue-600" },
        { icon: FileText, title: "Documentation", url: "docs.example.com", color: "bg-green-100 text-green-600" },
        { icon: ShoppingBag, title: "Store", url: "store.example.com", color: "bg-purple-100 text-purple-600" },
        { icon: Calendar, title: "Book Appointment", url: "book.example.com", color: "bg-orange-100 text-orange-600" },
    ];
                ...
                <div className="w-[280px] h-[570px] bg-gray-900 rounded-[40px] p-3 shadow-2xl">
                    ...
                    <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative">
                        ...
                        <div className="p-4 h-[calc(100%-24px)] overflow-y-auto">
                            {/* Header */}
                            <div className="mb-6">
                                <h2 className="text-xl font-bold text-gray-900 mb-1">My Links</h2>
                                <p className="text-sm text-gray-500">All your important links in one place</p>
                            </div>
