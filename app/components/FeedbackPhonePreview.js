                    ...
                    <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative">
                        ...
                        <div className="p-4 h-[calc(100%-24px)] overflow-y-auto">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <h2 className="text-xl font-bold text-gray-900 mb-1">We Value Your Feedback</h2>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex justify-center gap-2">
                                    {[...Array(5)].map((_, i) => (
                                        <button
                                            key={i}
                                            className={`p-2 rounded-lg transition-all ${i < 4
                                                    ? "text-yellow-400"
                                                    : "text-gray-300"
                                                }`}
                                        >
                                ...
                                <p className="text-center text-sm text-gray-500 mt-2">Excellent</p>
                            </div>
