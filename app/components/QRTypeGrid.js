...
export default function QRTypeGrid() {
  const qrTypes = [
    ...
    },
    {
      icon: Smartphone,
      label: "Apps",
      desc: "Redirect to an app store",
      href: "/create/apps",
    },
    {
      icon: LayoutTemplate,
      label: "Landing page",
      desc: "Create your own page",
      href: "/create/landing",
    },
    {
      icon: Package,
      label: "Product",
      desc: "Group information about your product",
      href: "/create/product",
    },
    {
      icon: Calendar,
      label: "Event",
      desc: "Promote and share an event",
      href: "/create/event",
    },
    {
      icon: Utensils,
      label: "Menu",
      desc: "Display the menu of a restaurant or bar",
      href: "/create/menu",
    },
    {
      icon: MessageSquare,
    ...
    },
    {
      icon: Music2,
      label: "Playlist",
      desc: "Share your own music",
      href: "/create/playlist",
    },
    {
      icon: ScanLine,
      label: "2D Barcode",
      desc: "Supports GS1 standards",
      isBarcode: true,
      href: "/create/barcode",
    },
  ];
    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {qrTypes.map((type, index) => {
          ...
          const className =
            "flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:border-blue-500 hover:shadow-md transition-all text-left group w-full";
