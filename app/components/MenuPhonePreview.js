...
export default function MenuPhonePreview() {
    const menuItems = [
        { name: "Classic Burger", desc: "Beef patty, lettuce, tomato", price: "$12" },
        { name: "Caesar Salad", desc: "Romaine, parmesan, croutons", price: "$10" },
        { name: "Margherita Pizza", desc: "Tomato, mozzarella, basil", price: "$15" },
                            ...
                            <div className="p-4">
                                ...
                                <div className="space-y-3">
                                    {menuItems.map((item, i) => (
                                        <div key={i} className="bg-white border border-gray-200 rounded-xl p-4 hover:border-amber-500 transition-colors">
